...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cronograma.estado'
        db.add_column(u'planificacion_cronograma', 'estado',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cronograma.estado'
        db.delete_column(u'planificacion_cronograma', 'estado')
    ...
    models = {
        ...
        u'planificacion.intervalocronograma': {
            'Meta': {'ordering': "['-cronograma__id', 'fecha_desde']", 'unique_together': "(('cronograma', 'maquina', 'secuencia'),)", 'object_name': 'IntervaloCronograma'},
