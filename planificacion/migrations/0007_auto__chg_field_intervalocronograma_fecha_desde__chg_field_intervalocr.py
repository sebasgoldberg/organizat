...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IntervaloCronograma.fecha_desde'
        db.alter_column(u'planificacion_intervalocronograma', 'fecha_desde', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'IntervaloCronograma.secuencia'
        db.alter_column(u'planificacion_intervalocronograma', 'secuencia', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'IntervaloCronograma.fecha_desde'
        db.alter_column(u'planificacion_intervalocronograma', 'fecha_desde', self.gf('django.db.models.fields.DateField')())

        # Changing field 'IntervaloCronograma.secuencia'
        db.alter_column(u'planificacion_intervalocronograma', 'secuencia', self.gf('django.db.models.fields.IntegerField')(default=None))
    ...
    models = {
        u'planificacion.cronograma': {
            ...
            'fecha_inicio': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 15, 0, 0)', 'null': 'True', 'blank': 'True'}),
