...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CronogramaMaquina'
        db.create_table(u'planificacion_cronogramamaquina', (
            (u'cronograma_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['planificacion.Cronograma'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'planificacion', ['CronogramaMaquina'])

        # Deleting field 'Cronograma.intervalo_tiempo'
        db.delete_column(u'planificacion_cronograma', 'intervalo_tiempo')


        # Changing field 'IntervaloCronograma.fecha_hasta'
        db.alter_column(u'planificacion_intervalocronograma', 'fecha_hasta', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):
        # Deleting model 'CronogramaMaquina'
        db.delete_table(u'planificacion_cronogramamaquina')

        # Adding field 'Cronograma.intervalo_tiempo'
        db.add_column(u'planificacion_cronograma', 'intervalo_tiempo',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=7, decimal_places=2),
                      keep_default=False)


        # Changing field 'IntervaloCronograma.fecha_hasta'
        db.alter_column(u'planificacion_intervalocronograma', 'fecha_hasta', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 4, 21, 0, 0)))
    ...
    models = {
        u'planificacion.cronograma': {
            ...
            'fecha_inicio': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 21, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'planificacion.cronogramamaquina': {
            'Meta': {'ordering': "['-id']", 'object_name': 'CronogramaMaquina', '_ormbases': [u'planificacion.Cronograma']},
            u'cronograma_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['planificacion.Cronograma']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'planificacion.intervalocronograma': {
            'Meta': {'ordering': "['-cronograma__id', 'maquina__descripcion', 'fecha_desde']", 'unique_together': "(('cronograma', 'maquina', 'secuencia'),)", 'object_name': 'IntervaloCronograma'},
