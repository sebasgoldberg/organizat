...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IntervaloCronograma.fecha_hasta'
        db.add_column(u'planificacion_intervalocronograma', 'fecha_hasta',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 4, 19, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IntervaloCronograma.fecha_hasta'
        db.delete_column(u'planificacion_intervalocronograma', 'fecha_hasta')
    ...
    models = {
        u'planificacion.cronograma': {
            ...
            'fecha_inicio': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 19, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'planificacion.intervalocronograma': {
            ...
            'fecha_hasta': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
