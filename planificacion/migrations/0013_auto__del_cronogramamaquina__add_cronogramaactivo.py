...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CronogramaActivo'
        db.create_table(u'planificacion_cronogramaactivo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cronograma', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['planificacion.Cronograma'])),
        ))
        db.send_create_signal(u'planificacion', ['CronogramaActivo'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'CronogramaActivo'
        db.delete_table(u'planificacion_cronogramaactivo')
    ...
    models = {
        ...
        u'planificacion.cronogramaactivo': {
            'Meta': {'object_name': 'CronogramaActivo'},
