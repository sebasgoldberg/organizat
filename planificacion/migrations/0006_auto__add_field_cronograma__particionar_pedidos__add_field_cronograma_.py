...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Cronograma', fields ['descripcion']
        db.delete_unique(u'planificacion_cronograma', ['descripcion'])

        # Adding field 'Cronograma._particionar_pedidos'
        db.add_column(u'planificacion_cronograma', '_particionar_pedidos',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Cronograma.tiempo_produccion_por_item'
        db.add_column(u'planificacion_cronograma', 'tiempo_produccion_por_item',
                      self.gf('django.db.models.fields.DecimalField')(default=40, max_digits=8, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cronograma._particionar_pedidos'
        db.delete_column(u'planificacion_cronograma', '_particionar_pedidos')

        # Deleting field 'Cronograma.tiempo_produccion_por_item'
        db.delete_column(u'planificacion_cronograma', 'tiempo_produccion_por_item')

        # Adding unique constraint on 'Cronograma', fields ['descripcion']
        db.create_unique(u'planificacion_cronograma', ['descripcion'])
    ...
    models = {
        u'planificacion.cronograma': {
            ...
            'fecha_inicio': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 9, 0, 0)', 'null': 'True', 'blank': 'True'}),
