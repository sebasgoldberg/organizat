...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cronograma.optimizar_planificacion'
        db.add_column(u'planificacion_cronograma', 'optimizar_planificacion',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cronograma.optimizar_planificacion'
        db.delete_column(u'planificacion_cronograma', 'optimizar_planificacion')
    ...
    models = {
        u'planificacion.cronograma': {
            ...
            'fecha_inicio': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 18, 0, 0)', 'null': 'True', 'blank': 'True'}),
