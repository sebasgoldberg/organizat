...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TareaItem'
        db.create_table(u'planificacion_tareaitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['produccion.ItemPedido'])),
            ('tarea', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['produccion.Tarea'])),
            ('cantidad_realizada', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=7, decimal_places=2)),
        ))
        db.send_create_signal(u'planificacion', ['TareaItem'])


    def backwards(self, orm):
        # Deleting model 'TareaItem'
        db.delete_table(u'planificacion_tareaitem')
    ...
    models = {
        u'planificacion.cronograma': {
            ...
            'fecha_inicio': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 27, 0, 0)', 'null': 'True', 'blank': 'True'}),
