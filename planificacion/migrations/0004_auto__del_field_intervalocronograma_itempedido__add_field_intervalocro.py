...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'IntervaloCronograma.itempedido'
        db.delete_column(u'planificacion_intervalocronograma', 'itempedido_id')

        # Adding field 'IntervaloCronograma.item'
        db.add_column(u'planificacion_intervalocronograma', 'item',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['produccion.ItemPedido'], null=True, on_delete=models.PROTECT),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'IntervaloCronograma.itempedido'
        raise RuntimeError("Cannot reverse this migration. 'IntervaloCronograma.itempedido' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'IntervaloCronograma.itempedido'
        db.add_column(u'planificacion_intervalocronograma', 'itempedido',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['produccion.ItemPedido'], on_delete=models.PROTECT),
                      keep_default=False)

        # Deleting field 'IntervaloCronograma.item'
        db.delete_column(u'planificacion_intervalocronograma', 'item_id')
