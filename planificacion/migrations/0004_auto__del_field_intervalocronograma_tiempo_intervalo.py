...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'IntervaloCronograma.tiempo_intervalo'
        db.delete_column(u'planificacion_intervalocronograma', 'tiempo_intervalo')


    def backwards(self, orm):
        # Adding field 'IntervaloCronograma.tiempo_intervalo'
        db.add_column(u'planificacion_intervalocronograma', 'tiempo_intervalo',
