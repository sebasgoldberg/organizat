...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Cronograma.fecha_inicio'
        db.alter_column(u'planificacion_cronograma', 'fecha_inicio', self.gf('django.db.models.fields.DateTimeField')(null=True))
        # Adding field 'IntervaloCronograma.fecha_desde'
        db.add_column(u'planificacion_intervalocronograma', 'fecha_desde',
        ...
        db.alter_column(u'planificacion_intervalocronograma', 'tiempo_intervalo', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'Cronograma.fecha_inicio'
        db.alter_column(u'planificacion_cronograma', 'fecha_inicio', self.gf('django.db.models.fields.DateField')(null=True))
        # Deleting field 'IntervaloCronograma.fecha_desde'
        db.delete_column(u'planificacion_intervalocronograma', 'fecha_desde')
    ...
    models = {
        u'planificacion.cronograma': {
            ...
            'fecha_inicio': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 13, 0, 0)', 'null': 'True', 'blank': 'True'}),
