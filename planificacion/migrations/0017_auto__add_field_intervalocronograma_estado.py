...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IntervaloCronograma.estado'
        db.add_column(u'planificacion_intervalocronograma', 'estado',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IntervaloCronograma.estado'
        db.delete_column(u'planificacion_intervalocronograma', 'estado')
    ...
    models = {
        u'planificacion.cronograma': {
            ...
            'fecha_inicio': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 25, 0, 0)', 'null': 'True', 'blank': 'True'}),
