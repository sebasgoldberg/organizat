...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cronograma.cantidad_extra_tarea_anterior'
        db.add_column(u'planificacion_cronograma', 'cantidad_extra_tarea_anterior',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=8, decimal_places=2),
                      keep_default=False)


        # Changing field 'IntervaloCronograma.item'
        db.alter_column(u'planificacion_intervalocronograma', 'item_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['produccion.ItemPedido'], null=True))

        # Changing field 'IntervaloCronograma.tareaproducto'
        db.alter_column(u'planificacion_intervalocronograma', 'tareaproducto_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['produccion.TareaProducto']))

    def backwards(self, orm):
        # Deleting field 'Cronograma.cantidad_extra_tarea_anterior'
        db.delete_column(u'planificacion_cronograma', 'cantidad_extra_tarea_anterior')


        # Changing field 'IntervaloCronograma.item'
        db.alter_column(u'planificacion_intervalocronograma', 'item_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['produccion.ItemPedido'], null=True, on_delete=models.PROTECT))

        # Changing field 'IntervaloCronograma.tareaproducto'
        db.alter_column(u'planificacion_intervalocronograma', 'tareaproducto_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['produccion.TareaProducto'], on_delete=models.PROTECT))
    ...
    models = {
        u'planificacion.cronograma': {
            ...
            'fecha_inicio': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 12, 0, 0)', 'null': 'True', 'blank': 'True'}),
