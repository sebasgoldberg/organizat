...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CostoCronograma'
        db.create_table(u'costos_costocronograma', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('costo', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=3)),
            ('cronograma', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['planificacion.Cronograma'], unique=True)),
        ))
        db.send_create_signal(u'costos', ['CostoCronograma'])


    def backwards(self, orm):
        # Deleting model 'CostoCronograma'
        db.delete_table(u'costos_costocronograma')


    models = {
        u'costos.costocronograma': {
            'Meta': {'object_name': 'CostoCronograma'},
            'costo': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '12', 'decimal_places': '3'}),
            'cronograma': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['planificacion.Cronograma']", 'unique': 'True'}),
